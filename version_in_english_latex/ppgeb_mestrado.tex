...
\scalebox{1.3}{\bfseries\scshape Appendix~\ref{apendice_exemplo}}
\addcontentsline{toc}{chapter}{Appendix~\ref{apendice_exemplo}}
\end{flushright}

\noindent\begin{large}{\bfseries\scshape Appendix Example}\end{large} \label{sec:appendix1}
...
\scalebox{1.3}{\bfseries\scshape Appendix~\ref{apendice_outro_exemplo}}
\addcontentsline{toc}{chapter}{Appendix~\ref{apendice_outro_exemplo}}
\end{flushright}

\noindent\begin{large}{\bfseries\scshape Another Appendix Example}\end{large} \label{sec:appendix2}
...
\scalebox{1.3}{\bfseries\scshape Annex~\ref{anexo_exemplo}}
\addcontentsline{toc}{chapter}{Annex~\ref{anexo_exemplo}}
\end{flushright}
...
\scalebox{1.3}{\bfseries\scshape Annex~\ref{anexo_outro_exemplo}}
\addcontentsline{toc}{chapter}{Annex~\ref{anexo_outro_exemplo}}
\end{flushright}
